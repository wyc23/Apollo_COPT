...
model_save_path = f'./pretrain/{train_task}_/'
log_save_path = f"train_logs/{train_task}_/"
...
TRAIN_BG = f'./dataset/{TaskName}/train/BG'
TRAIN_SOL = f'./dataset/{TaskName}/train/solution'
train_names = os.listdir(TRAIN_BG)
train_files = [ (os.path.join(TRAIN_BG,name), os.path.join(TRAIN_SOL,name).replace('bg','sol')) for name in train_names]

VALID_BG = f'./dataset/{TaskName}/valid/BG'
VALID_SOL = f'./dataset/{TaskName}/valid/solution'
valid_names = os.listdir(VALID_BG)
valid_files = [ (os.path.join(VALID_BG,name), os.path.join(VALID_SOL,name).replace('bg','sol')) for name in valid_names]
